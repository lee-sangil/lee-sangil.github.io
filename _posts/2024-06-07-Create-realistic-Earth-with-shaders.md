...
> Let's return to creating a realistic Earth using Three.js. Unlike the previous Earth[^PBR], we are going to render Earth using shader material. Firstly, we will describe the day and night with two different textures, since there are city lights at night. Secondly, I'll make an effect for mountain shadow and ocean reflection to make texture more realistic. Also, I'll depict the flowing cloud and its shadow. Lastly, a high-quality eclipse shadow will be cast on the surface of Earth.
